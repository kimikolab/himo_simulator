...
## Status Bar（ステータスバー）スクリーン ##############################################
##
## ゲーム中、画面上部に常時表示するパラメータバー。
## 所持金・信頼度・依存度の3つのみ表示する（v2.5仕様）。
...
screen status_detail():
    ...
    frame:
        ...
        vbox:
            ...
            text "ステータス詳細" size 35 xalign 0.5

            null height 10

            text "■プレイヤー" size 28
            text "所持金: ¥[player['money']:,]" size 22
            text "体力: [player['stamina']]/100（裏）" size 20 color "#999999"
            text "清潔感: [player['cleanliness']]（裏）" size 20 color "#999999"
