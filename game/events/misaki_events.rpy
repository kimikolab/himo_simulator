...
label misaki_date_day1:
    ...
    "待ち合わせの駅前に着いた。"
    "平日の夜。仕事帰りの人たちがぞろぞろと改札から出てくる。"

    himo "（美咲、変わってるかな）"
    himo "（つーか、俺が私服でこいつらがスーツって、なんか変な感じ）"

    "少し待っていると、スーツ姿の女が小走りで近づいてきた。"

    show misaki normal with dissolve

    misaki_c "ヒモ太郎？ ...ヒモ太郎だよね？"
    himo "おう。久しぶり"
    misaki_c "久しぶり！ わ、全然変わってない"
    himo "美咲こそ。なんかちゃんとしてんな、スーツとか"
    misaki_c "仕事帰りだから...あ、ごめん、もっとちゃんとした格好で来ればよかった"
    himo "いや全然。俺なんてこれだし"

    "お互い、ちょっとぎこちない。"
    "高校のときは普通に話してたはずなのに、何年も会わないとこうなるんだな。"
    ...
    "乾杯した。"
    "最初の一口で、ちょっと空気がほぐれた気がした。"

    # ========================================
    # 近況報告
    # ========================================

    misaki_c "で、ヒモ太郎は今何してるの？"
    ...
    menu:
        ...
        "笑いに変える":
            himo "自由業。主な業務内容は、昼寝と散歩"
            misaki_c "あはは、なにそれ"
            himo "休日は年中無休です"
            misaki_c "それ休日って言わない笑"
    ...
    himo "美咲は？大手入ったんだろ、すげえじゃん"

    misaki_c "うん、まあ...入ったはいいんだけど"

    "美咲がビールを一口飲んで、少し黙った。"

    show misaki sad

    misaki_c "毎日終電で、休日も持ち帰りで"
    misaki_c "やりがいはあるんだけど...なんていうか"

    himo "大変そうだな"

    misaki_c "周りはどんどん昇進とか結婚とかしてて"
    misaki_c "私はなんか、ずっと同じ場所にいる感じ"

    show misaki smile
    "美咲がちょっと寂しそうに笑った。"

    misaki_c "...ごめん、暗い話しちゃって"
    misaki_c "久しぶりに会ったのに"
    ...
    menu:
        ...
        "気にすんなって":
            himo "いいよ別に。俺に気ぃ使わなくて"
            misaki_c "...うん"
            himo "つーか、毎日終電ってすげえよ。俺には絶対無理"
            misaki_c "ヒモ太郎は3日で辞めそう"
            himo "3日ももたない"
            misaki_c "笑"
        ...
        "俺なんか比じゃないだろ":
            himo "少なくとも俺よりはちゃんとしてるって"
            himo "無職に慰められても嬉しくないだろうけど"
            misaki_c "ふふ...そんなことないよ"
            misaki_c "なんか、ヒモ太郎と話してると気楽でいいな"
        ...
        "黙って聞く":
            ...
            misaki_c "...聞いてくれるだけでいいんだよね、こういうの"
            himo "ん？ああ、聞いてる聞いてる"
            misaki_c "ありがとう"
    ...
    "二杯目を頼んだあたりから、昔の話になった。"

    misaki_c "ヒモ太郎って、高校のとき何してた？"
    himo "何もしてなかった。帰宅部だし"
    misaki_c "だよね。いっつも早く帰ってた"
    himo "美咲は確か...図書委員？"
    misaki_c "そうそう。よく覚えてるね"
    himo "静かに本読んでるイメージあるわ"
    misaki_c "地味だったからね、私"

    "地味、というか、目立たないタイプだった。"
    "でも今こうして話すと、普通に話しやすい。"

    misaki_c "卒業してから、同級生と会うのってほとんどなくて"
    misaki_c "だから今日、ちょっと緊張してた"
    himo "俺も。ちょっとだけ"
    misaki_c "ほんとに？"
    himo "...ちょっとだけな"
    ...
    "割り勘にすると、2,100円。ギリ払えるけど、明日からどうする。"
    "かといって、ここで「金ない」とは言えない。"

    misaki_c "あ、ここ私が出すよ"
    himo "え、いいよ悪い"
    misaki_c "今日は私が誘ったんだし"
    misaki_c "それに...楽しかったから"
...
label M03_go:
    scene bg_misaki_room with fade
    "美咲の部屋に来た。"
    "清潔で、でも少し生活感がある部屋。"
    "本棚には仕事の資料が並んでいる。"
